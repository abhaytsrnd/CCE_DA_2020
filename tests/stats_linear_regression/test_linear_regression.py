...
class TestLinearRegression(TestCase):
    ...
    def test_linear_model_bivariate_fit(self):
        ...
        actual_stats = [{'count': 8, 'mean': 13.0, 'variance': 6.857142857142857, 'std': 2.6186146828319083, 'min': 10.0, 'max': 16.0, 'covariance': 34.857142857142854, 'r': 0.7539487656439327}, {'count': 8, 'mean': 2.75, 'variance': 1.6428571428571428, 'std': 1.2817398889233114, 'min': 1.0, 'max': 4.0, 'covariance': 9.571428571428571, 'r': 0.42295923256718326}, {'count': 8, 'mean': 75.0, 'variance': 311.7142857142857, 'std': 17.65543218712829, 'min': 48.0, 'max': 101.0, 'covariance': 311.7142857142857, 'r': 1.0}]
        ...
        self.assertEqual(model.params(), actual_params)
        self.assertEqual(model.predicts(data), actual_ycap)
        self.assertEqual(model.predict([15,5]), 104.0671641791044)
    ...
    def test_linear_model_trivariate_fit(self):
        ...
        actual_stats = [{'count': 8, 'mean': 13.0, 'variance': 6.857142857142857, 'std': 2.6186146828319083, 'min': 10.0, 'max': 16.0, 'covariance': 34.857142857142854, 'r': 0.7539487656439327}, {'count': 8, 'mean': 2.75, 'variance': 1.6428571428571428, 'std': 1.2817398889233114, 'min': 1.0, 'max': 4.0, 'covariance': 9.571428571428571, 'r': 0.42295923256718326}, {'count': 8, 'mean': 47.5, 'variance': 50.0, 'std': 7.0710678118654755, 'min': 40.0, 'max': 60.0, 'covariance': 84.28571428571429, 'r': 0.675134989581633}, {'count': 8, 'mean': 75.0, 'variance': 311.7142857142857, 'std': 17.65543218712829, 'min': 48.0, 'max': 101.0, 'covariance': 311.7142857142857, 'r': 1.0}]
        ...
        self.assertEqual(model.params(), actual_params)
        self.assertEqual(model.predicts(data), actual_ycap)
        self.assertEqual(model.predict([15,5,35]), 95.79927007299364)
